...
builder.Services.AddSingleton<HermesMiddleware>();
...
builder.Services.AddGraphQL(b => b
    ...
    .AddDataLoader()
    .AddSystemTextJson()
    .AddSelfActivatingSchema<HermesSchema>()
    .AddGraphTypes(typeof(HermesSchema).Assembly));
...
app.UseGraphQL<HermesSchema>("/graphql");
